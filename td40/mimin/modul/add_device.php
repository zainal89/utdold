...
<section class="content">
  <div class="container-fluid">
    <div class="card">
      <div class="card-body">
          <form class="form-horizontal" method="POST" action="modul/p_add_device.php">
              <div class="form-group row">
                <label for="f_bmn" class="col-sm-2 col-form-label">BMN</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="f_bmn" name="f_bmn" placeholder="BMN" required>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="f_nama" name="f_nama" placeholder="Nama Peralatan" required>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="f_merk" name="f_merk" placeholder="Merk Peralatan" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="f_type" class="col-sm-2 col-form-label">Type</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="f_type" name="f_type" placeholder="Type Peralatan" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="f_type" class="col-sm-2 col-form-label">Instruksi Kerja</label>
                <div class="col-sm-10">
                  <textarea id="summernote" name="f_ika" required></textarea>
                </div>
              </div>
            <!--   <div class="form-group row">
