...
<!-- Main content -->
 ...
 ?>
                      ...
                      <td><a type="button" target="_blank" href="qrview.php?id=<?=md5($r['kode'])?>" class="btn btn-block btn-outline-primary btn-xs">View QR</a></td>
                      <td class="text-center"><a type="button" href="?act=abs&id=<?=$r['id']?>" class="btn btn-block btn-outline-success btn-xs">Edit</a></td>
                       </tr>
                    <?php
