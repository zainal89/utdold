...
$mimin = coc_sql("SHOW", "tb_mimin", "*", "id = '$_SESSION[s_id_mimin]'");
$r = $mimin->fetch_array();
$user_foto = $r['foto'];
$user_nama = $r['nama'];
$user_hp   = $r['hp'];
...
<head>
  ...
  <title>Unit Transformasi Digital 4.0</title>
  ...
  <link rel="stylesheet" href="<?=pathplugins?>tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    ...
    <!-- summernote editor -->
  <link rel="stylesheet" href="<?=pathplugins?>summernote/summernote-bs4.min.css">
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="<?=pathimgapp?>atim.png" alt="TD 4.0 Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">TD 4.0</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <strong>&copy; 2022 <a href="#">COC Design</a></strong>
  </footer>
...
<!-- Summernote -->
<script src="<?=pathplugins?>summernote/summernote-bs4.min.js"></script>
