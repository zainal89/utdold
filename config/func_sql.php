...
function periode_aktif(){
	return coc_value("tb_periode", "id", "status='1'");
}

function val_paktif($waktu){
    return coc_value("tb_periode", "tahun", "id=$waktu");
}

function val_saktif($semester){
    $m = coc_value("tb_periode", "semester", "id=$semester");
	return semester($m);
}
